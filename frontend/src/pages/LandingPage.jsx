...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--background)' }} data-testid="landing-page">
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-4 relative z-10" style={{ background: 'var(--background)' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger-children">
            <div className="glass-card rounded-3xl p-8 text-center">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ background: isDark ? 'rgba(124, 58, 237, 0.2)' : 'rgba(138, 180, 248, 0.2)' }}>
            ...
            <div className="glass-card rounded-3xl p-8 text-center">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ background: isDark ? 'rgba(245, 158, 11, 0.2)' : 'rgba(253, 203, 110, 0.2)' }}>
            ...
            <div className="glass-card rounded-3xl p-8 text-center">
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6" style={{ background: isDark ? 'rgba(16, 185, 129, 0.2)' : 'rgba(85, 239, 196, 0.2)' }}>
      ...
      {/* Footer */}
      <footer className="py-8 px-4 border-t relative z-10" style={{ borderColor: 'var(--glass-border)' }}>
